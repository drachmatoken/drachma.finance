...
contract DrachmaToken is ERC20 {
    ...
    constructor() public payable ERC20("Drachma.finance", "DRAC") {
        owner = msg.sender;
        uint256 supply = 18750;
        _mint(msg.sender, supply.mul(10 ** 18));
        lastBlockSent = block.number;
    }

   function setObolAddress(address obolAddress) public _onlyOwner {
       obol = IERC20(obolAddress);
   }
